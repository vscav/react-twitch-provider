...
const cheermotesData: Cheermotes = [
  {
    ...
    type: 'channel_custom',
    order: 1,
    last_updated: '2022-10-31T00:06:04Z',
    is_charitable: false,
  },
  {
    prefix: 'Cheer',
    tiers: [
      {
        ...
        images: {
          dark: {
            ...
            static: {
              '1': 'https://d3aqoihi2n8ty8.cloudfront.net/actions/cheer/dark/static/1/10000.png',
              '1.5': 'https://d3aqoihi2n8ty8.cloudfront.net/actions/cheer/dark/static/1/10000.5.png',
              '2': 'https://d3aqoihi2n8ty8.cloudfront.net/actions/cheer/dark/static/1/10000.png',
              '3': 'https://d3aqoihi2n8ty8.cloudfront.net/actions/cheer/dark/static/1/10000.png',
              '4': 'https://d3aqoihi2n8ty8.cloudfront.net/actions/cheer/dark/static/1/10000.png',
            },
          },
          light: {
            animated: {
    ...
    type: 'channel_custom',
    order: 1,
    last_updated: '2022-11-01T00:09:04Z',
    is_charitable: false,
  },
]

export { cheermotesData }
